...
goodreads<-read.table("C:/Users/Abigail/Desktop/Reverse/goodreadsR/pliv_int_goodreadsR.txt",header=TRUE) #read in list of names we need; to change each time the file changes
...
write.fasta(seq_out_table_all[,1],names=seq_out_table_all[,2],"C:/Users/Abigail/Desktop/Reverse/out_fasta_R/pliv_int_alloutR.fasta") 
